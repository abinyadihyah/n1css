...
function calculateIntermediateColors($color1, $color2)
{
    $intermediateColors = [];
    $intermediateColors[] = interpolateHexColors($color1, $color2, 0.33);
    $intermediateColors[] = interpolateHexColors($color1, $color2, 0.66);
    return $intermediateColors;
}

// Color set 1 - Light Mode
// Calculate intermediate colors for Color set 1
$intermediateColors_set1 = calculateIntermediateColors($slate_100, $slate_400);

// Color set 2 - Dark Mode
// Calculate intermediate colors for Color set 2
$intermediateColors_set2 = calculateIntermediateColors($dm_slate_100, $dm_slate_400);
...
<style>
    :root {
        ...
        --slate-200: <?php echo $intermediateColors_set1[0]; ?>;
        --slate-300: <?php echo $intermediateColors_set1[1]; ?>;
        ...
        --dark-mode-300: <?php echo $intermediateColors_set2[1]; ?>;
        --dark-mode-200: <?php echo $intermediateColors_set2[0]; ?>;
